...
_svg_pattern_init (svg_pattern_t *pattern, svg_element_t *parent, svg_t *doc)
{
    ...
    status = _svg_element_create (&pattern->group_element,
				  ...
				  parent, doc);
    _svg_element_reference(pattern->group_element);
...
svg_status_t _svg_pattern_init_copy (svg_pattern_t *pattern,
	...
	status = _svg_element_clone (NULL, &pattern->group_element, other->group_element);
	if (status)
		return status;
...
{
    _svg_element_dereference (pattern->group_element);
